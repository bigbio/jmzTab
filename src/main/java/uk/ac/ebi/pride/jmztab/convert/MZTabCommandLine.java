package uk.ac.ebi.pride.jmztab.convert;
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Option convertOption = OptionBuilder.withArgName(inFileOpt + ", " + formatOpt)
            .hasArgs()
            .withValueSeparator()
            .withDescription("Converts the given format file (MZIDENTML) to an mztab file.")
            .create(convertOpt);
        ...
        if (line.hasOption(helpOpt)) {
            ...
            if (line.hasOption(checkOpt)) {
                ...
                File inFile = null;
                MassSpecFileFormat format = MassSpecFileFormat.MZIDENTML;
    ...
    private static void printHelpHack() {
        System.out.println("usage: jmztab\n" +
                ...
                " -convert inFile=<inFile> format=<format>   Converts the given format file (MZIDENTML) to an mztab\n" +
                "                                            file.\n" +
